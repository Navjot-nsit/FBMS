...
public class Teams extends JFrame {
	...
	public Teams() {
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String query = "select * from teams where City = ?";
					PreparedStatement pst = conn.prepareStatement(query);
		...
		JLabel lblSelectATeam = new JLabel("Note : Select a Team from the list above to know its Home Stadium, Coach and Players");
